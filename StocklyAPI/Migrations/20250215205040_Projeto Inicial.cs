        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasElevatedPrivileges = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Admin_RegistrationDate_Valid", "RegistrationDate <= GETDATE()");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Customer_DateOfBirth_Valid", "DateOfBirth <= GETDATE()");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Sales_Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sales_HireDate_Valid", "HireDate <= GETDATE()");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_OrderDate_Valid", "OrderDate <= GETDATE()");
